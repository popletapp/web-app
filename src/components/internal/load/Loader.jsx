    ...
    return (
      <div className='loading fadeOutZoomIn'>
        ...
        <div className='container' style={{ display: 'flex', flexDirection: 'column' }}>
          <div className='poplet-icon-bg-top' style={{ height: '47.6%', width: '100%' }} />
        </div>
        <div className='container' style={{ display: 'flex', flexDirection: 'row' }}>
          <div className='poplet-icon-bg-left' style={{ height: '100%', width: '48%' }} />
          <div className='poplet-icon-bg-bottom' style={{ position: 'absolute', bottom: '0', left: '47%', height: '48%', width: '120px' }} />
          <div className='poplet-icon-bg-right' style={{ position: 'absolute', left: '52%', height: '100%', width: '47%' }} />
        </div>
